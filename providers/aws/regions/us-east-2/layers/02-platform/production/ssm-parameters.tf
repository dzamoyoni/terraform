...
resource "aws_ssm_parameter" "cluster_name" {
  name        = "/ohio-01-EKS/${var.environment}/${var.region}/platform/cluster-name"
...
resource "aws_ssm_parameter" "cluster_endpoint" {
  name        = "/ohio-01-EKS/${var.environment}/${var.region}/platform/cluster-endpoint"
...
resource "aws_ssm_parameter" "cluster_certificate_authority_data" {
  name        = "/ohio-01-EKS/${var.environment}/${var.region}/platform/cluster-certificate-authority-data"
...
resource "aws_ssm_parameter" "cluster_oidc_issuer_arn" {
  name        = "/ohio-01-EKS/${var.environment}/${var.region}/platform/cluster-oidc-issuer-arn"
