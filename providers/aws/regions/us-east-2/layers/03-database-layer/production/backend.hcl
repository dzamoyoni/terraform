# =============================================================================
# Backend Configuration: Layer 3 Database Layer - us-east-2 production
# =============================================================================
...
key    = "providers/aws/regions/us-east-2/layers/03-database-layer/production/terraform.tfstate"
region = "us-east-2"
encrypt = true
