# =============================================================================
# Backend Configuration: standalone-compute Layer - us-east-2 production
# =============================================================================
...
key    = "providers/aws/regions/us-east-2/layers/04-standalone-compute/production/terraform.tfstate"
region = "us-east-2"
encrypt = true
