# =============================================================================
# Backend Configuration: observability Layer - us-east-2 production
# =============================================================================
...
key    = "providers/aws/regions/us-east-2/layers/06-observability/production/terraform.tfstate"
region = "us-east-2"
encrypt = true
