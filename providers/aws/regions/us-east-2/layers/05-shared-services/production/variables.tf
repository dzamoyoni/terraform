...
variable "enable_system_nodegroup" {
  description = "Enable system nodegroup for shared services workloads"
  type        = bool
  default     = true
}

variable "system_nodegroup_instance_types" {
  description = "Instance types for system nodegroup"
  type        = list(string)
  default     = ["m5.large", "m5a.large", "t3.large"]
}

variable "system_nodegroup_capacity_type" {
  description = "Capacity type for system nodegroup (ON_DEMAND or SPOT)"
  type        = string
  default     = "ON_DEMAND"
}
...
variable "system_nodegroup_disk_size" {
  description = "Disk size for system nodegroup nodes in GB"
  type        = number
  default     = 50
}
