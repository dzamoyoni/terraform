# =============================================================================
# Backend Configuration: shared-services Layer - us-east-2 production
# =============================================================================
...
key    = "providers/aws/regions/us-east-2/layers/05-shared-services/production/terraform.tfstate"
region = "us-east-2"
encrypt = true
