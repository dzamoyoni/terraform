# =============================================================================
# Backend Configuration: client-nodegroups Layer - af-south-1 production
# =============================================================================
...
key    = "providers/aws/regions/af-south-1/layers/05-client-nodegroups/production/terraform.tfstate"
region = "af-south-1"
encrypt = true
