# =============================================================================
# Backend Configuration: shared-services Layer - af-south-1 production
# =============================================================================
...
key    = "providers/aws/regions/af-south-1/layers/06-shared-services/production/terraform.tfstate"
region = "af-south-1"
encrypt = true
