# =============================================================================
# Backend Configuration: client-nodegroups Layer - us-east-1 production
# =============================================================================
...
key    = "providers/aws/regions/us-east-1/layers/05-client-nodegroups/production/terraform.tfstate"
region = "us-east-1"
encrypt = true
