# =============================================================================
# Backend Configuration: shared-services Layer - us-east-1 production
# =============================================================================
...
key    = "providers/aws/regions/us-east-1/layers/06-shared-services/production/terraform.tfstate"
region = "us-east-1"
encrypt = true
