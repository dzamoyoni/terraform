# =============================================================================
# Backend Configuration: standalone-compute Layer - us-east-1 production
# =============================================================================
...
key    = "providers/aws/regions/us-east-1/layers/03-standalone-compute/production/terraform.tfstate"
region = "us-east-1"
encrypt = true
