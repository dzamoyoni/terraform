# =============================================================================
# Backend Configuration: observability Layer - us-east-1 production
# =============================================================================
...
key    = "providers/aws/regions/us-east-1/layers/03.5-observability/production/terraform.tfstate"
region = "us-east-1"
encrypt = true
